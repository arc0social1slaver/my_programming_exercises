...
float University::getBest(int choice)
{
    ...
    for (int i = 0; i < (*numOfStudents); i++)
    {
        float score = pupil[typeStudents][i].getGPA();
    ...
    else
    {
        ...
        else
        {
            for (int i = 0; i < (*numOfStudents); i++)
            {
                ...
                if (name != "")
                {
                    if (pupil[typeStudents][i].getGPA() == studHighest)
                    {
...
void University::study(string name, int choice)
{
    ...
    else
    {
        ...
        {
            pupil[typeStudents][position].doAssign();
            pupil[typeStudents][position].takeTest();
            pupil[typeStudents][position].takeExam();
        }
    }
}